...
function AuthCard({ mode }) {
    ...
    const submit = async ()=>{
        try {
            setLoading(true);
            setError("");
            const result = isLogin ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginWithEmail"])(email, password) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerWithEmail"])(email, password);
    ...
    const loginGithub = async ()=>{
        const url = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getGithubLoginUrl"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45fc833e._.js.map